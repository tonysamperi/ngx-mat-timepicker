import { NgxMatTimepickerActiveMinutePipe } from './ngx-mat-timepicker-active-minute.pipe';

describe('NgxMatTimepickerActiveMinutePipe', () => {
    const pipe = new NgxMatTimepickerActiveMinutePipe();
