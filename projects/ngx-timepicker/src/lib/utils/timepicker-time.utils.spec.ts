...
import { NgxTimepickerUtils } from './ngx-timepicker.utils';
...
describe('TimepickerTime', () => {
    describe('Hour', () => {
        ...
        it('should return 12 hours', () => {
            const hours = NgxTimepickerUtils.getHours(12);
        ...
        it('should return 24 hours', () => {
            const hours = NgxTimepickerUtils.getHours(24);
            for (let i = 0; i < hours.length; i++) {
                const angleStep = 30;
                const time = i + 1;
        ...
        it('should disable hours if min time present (12 hours format)', () => {
            const hours = NgxTimepickerUtils.getHours(12);
            let disabledHours = NgxTimepickerUtils.disableHours(hours, {
                min,
                max: undefined,
                format: 12,
                period: NgxTimepickerPeriods.AM
            }).filter(h => h.disabled);
            ...
            disabledHours = NgxTimepickerUtils.disableHours(hours, {
                min,
                max: undefined,
                format: 12,
                period: NgxTimepickerPeriods.PM
            }).filter(h => h.disabled);
        ...
        it('should disable hours if min and max time present (24 hours format)', () => {
            const hours = NgxTimepickerUtils.getHours(24);
            const disabledHours = NgxTimepickerUtils.disableHours(hours, {
                min,
                max,
                format: 24,
            }).filter(h => h.disabled);
    ...
    describe('Minute', () => {
        ...
        it('should return minutes with gap in 5 minutes', () => {
            const gap = 5;
            const minutesWithGap = NgxTimepickerUtils.getMinutes(gap);
            const angleStep = 360 / 60;
        ...
        it('should disable minutes with min time', () => {
            let disabledMinutes = NgxTimepickerUtils.disableMinutes(minutes, 1, {
                min,
                max: undefined,
                format: 12,
                period: NgxTimepickerPeriods.AM
            ...
            disabledMinutes = NgxTimepickerUtils.disableMinutes(minutes, 2, {
                min,
                max: undefined,
                format: 12,
                period: NgxTimepickerPeriods.AM
            ...
            disabledMinutes = NgxTimepickerUtils.disableMinutes(minutes, 0, {
                min,
                max: undefined,
                format: 12,
                period: NgxTimepickerPeriods.AM
        ...
        it('should disable minutes with max time', () => {
            let disabledMinutes = NgxTimepickerUtils.disableMinutes(minutes, 3, {
                min: undefined,
                max,
                format: 12,
                period: NgxTimepickerPeriods.AM
            ...
            disabledMinutes = NgxTimepickerUtils.disableMinutes(minutes, 4, {
                min: undefined,
                max,
                format: 12,
                period: NgxTimepickerPeriods.AM
        ...
        it('should return minutes without disabling if nor min and max values were provided', () => {
            const disabledHours = NgxTimepickerUtils.disableMinutes(minutes, 1, {
                min: undefined,
                max: undefined,
                format: 24,
            }).filter(h => h.disabled);
