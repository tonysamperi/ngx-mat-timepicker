...
describe('TimepickerUtils', () => {
    ...
    describe('isSameOrAfter', () => {
        ...
        it('should return true if time the same or more than min value', () => {
            ...
            let time = NgxTimepickerAdapter.parseTime('11:12 am', {locale});
            let isSameOrAfterVar = isSameOrAfter(time, min);
            expect(isSameOrAfterVar).toBeTruthy();

            time = NgxTimepickerAdapter.parseTime('11:11 am', {locale});
        ...
        it('should return false if hour less than min value', () => {
            const min = NgxTimepickerAdapter.parseTime('11:11 am', {locale});
            const time = NgxTimepickerAdapter.parseTime('10:12 am', {locale});
    ...
    describe('isSameOrBefore', () => {
        ...
        it('should return true if time before or equal max value', () => {
            const max = NgxTimepickerAdapter.parseTime('11:11 am', {locale});
            let time = NgxTimepickerAdapter.parseTime('11:10 am', {locale});
        ...
        it('should return false if hour more than max', () => {
            const max = NgxTimepickerAdapter.parseTime('11:11 am', {locale});
            const time = NgxTimepickerAdapter.parseTime('12:10 pm', {locale});
    ...
    describe('isBetween', () => {
        ...
        it('should return true if time between min(inclusively) and max(inclusively) value', () => {
            const min = NgxTimepickerAdapter.parseTime('09:00 am', {locale});
            const max = NgxTimepickerAdapter.parseTime('03:00 pm', {locale});
            let time = NgxTimepickerAdapter.parseTime('12:12 pm', {locale});
            let isBetweenVar = isBetween(time, min, max);
            expect(isBetweenVar).toBeTruthy();

            time = NgxTimepickerAdapter.parseTime('09:00 am', {locale});
            isBetweenVar = isBetween(time, min, max);
            expect(isBetweenVar).toBeTruthy();

            time = NgxTimepickerAdapter.parseTime('03:00 pm', {locale});
            isBetweenVar = isBetween(time, min, max);
            expect(isBetweenVar).toBeTruthy();
        });
        ...
        it('should return false if hour is not between min(inclusively) and max(inclusively) value', () => {
            const min = NgxTimepickerAdapter.parseTime('09:00 am', {locale});
            const max = NgxTimepickerAdapter.parseTime('03:00 pm', {locale});
            const time = NgxTimepickerAdapter.parseTime('04:05 pm', {locale});
