...
describe('NgxTimepickerDirective', () => {
    const consoleWarnValue = 'Selected time doesn\'t match min or max value';
    let fixture: ComponentFixture<TestComponent>;
    let input: DebugElement;
    let directive: NgxTimepickerDirective;
    let timepickerComponent: NgxTimepickerComponent;
    ...
    beforeEach(() => {
        ...
        input = fixture.debugElement.query(By.directive(NgxTimepickerDirective));
        directive = input.injector.get<NgxTimepickerDirective>(NgxTimepickerDirective);
        timepickerComponent = TestBed.createComponent(NgxTimepickerComponent).componentInstance;
    });

    it('should register NgxTimepickerComponent', () => {
    ...
    it('should throw Error if NgxTimepickerComponent is not defined', () => {
        spyOnProperty(directive, 'timepicker', 'set').and.callThrough();
        expect(() => directive.timepicker = null).toThrowError('NgxTimepickerComponent is not defined.' +
