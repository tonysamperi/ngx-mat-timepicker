...
import {NgxTimepickerHoursFace} from "./ngx-timepicker-hours-face";

@Component({
    template: "<h1>Test</h1>"
})
class Test12HoursComponent extends NgxTimepickerHoursFace {
    constructor() {
        super(12);
    }
}
...
class Test24HoursComponent extends NgxTimepickerHoursFace {
    constructor() {
        super(24);
    }
}

describe("NgxTimepickerHoursFace", () => {
