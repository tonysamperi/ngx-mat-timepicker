...
export class NgxTimepickerControlComponent implements OnChanges {
    ...
    @Input() timeList: NgxTimepickerClockFace[];
    @Input() timeUnit: NgxTimepickerUnits;

    private _color: ThemePalette = "primary";
    private _previousTime: number;

    constructor(private _timeParser: NgxTimepickerParserPipe) {
    }
    ...
    private _isSelectedTimeDisabled(time: number): boolean {
        return this.timeList.find((faceTime: NgxTimepickerClockFace) => faceTime.time === time).disabled;
    }
