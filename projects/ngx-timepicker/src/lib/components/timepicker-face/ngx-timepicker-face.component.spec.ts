...
import {NgxTimepickerFaceComponent} from "./ngx-timepicker-face.component";
...
describe("NgxTimepickerFaceComponent", () => {
    let fixture: ComponentFixture<NgxTimepickerFaceComponent>;
    let component: NgxTimepickerFaceComponent;
    ...
    beforeEach(() => {
        ...
        }).createComponent(NgxTimepickerFaceComponent);

        component = fixture.componentInstance;
    });

    it("trackByTime should return time", () => {
        const time: NgxTimepickerClockFace = {time: 10, angle: 360};
    ...
    it("should select available time", fakeAsync(() => {
        ...
        let updatedTime: NgxTimepickerClockFace = {time: 1, angle: 20};
    ...
    describe("Select time", () => {
        ...
        it("should return angle from I quarter", fakeAsync(() => {
            let selectedTime: NgxTimepickerClockFace = {time: 1, angle: 5};
        ...
        it("should select minute from list", fakeAsync(() => {
            ...
            component.unit = NgxTimepickerUnits.MINUTE;
            component.timeChange.subscribe((time) => selectedTime = time);
