...
@Component({
    selector: "ngx-timepicker-face",
    templateUrl: "./ngx-timepicker-face.component.html",
    styleUrls: ["./ngx-timepicker-face.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class NgxTimepickerFaceComponent implements AfterViewInit, OnChanges, OnDestroy {
    ...
    @Input()
    faceTime: NgxTimepickerClockFace[];
    ...
    @Input()
    selectedTime: NgxTimepickerClockFace;


    @Output()
    timeChange = new EventEmitter<NgxTimepickerClockFace>();
    ...
    selectTime(e: any): void {
        ...
        const angleStep = this.unit === NgxTimepickerUnits.MINUTE ? (6 * (this.minutesGap || 1)) : 30;
    ...
    trackByTime(_item_, time: NgxTimepickerClockFace): string | number {
        return time.time;
    }
