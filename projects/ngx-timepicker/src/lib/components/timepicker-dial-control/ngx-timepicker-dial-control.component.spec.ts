...
import { NgxTimepickerDialControlComponent } from './ngx-timepicker-dial-control.component';
...
describe('NgxTimepickerDialControlComponent', () => {
    let fixture: ComponentFixture<NgxTimepickerDialControlComponent>;
    let component: NgxTimepickerDialControlComponent;
    ...
    beforeEach(() => {
        fixture = TestBed.configureTestingModule({
            ...
            providers: [
                NgxTimepickerParserPipe,
                {provide: NGX_TIMEPICKER_LOCALE, useValue: 'ar-AE'}
            ],
            schemas: [NO_ERRORS_SCHEMA]
        }).createComponent(NgxTimepickerDialControlComponent);
    ...
    it('should set current time to previous time, change time unit and emit focus event', async(() => {
        let counter = 0;
        component.timeUnitChanged.subscribe(unit => expect(unit).toBe(NgxTimepickerUnits.MINUTE));
        component.focused.subscribe(() => expect(++counter).toBe(1));

        component.time = '10';
        expect(component.previousTime).toBeUndefined();

        component.saveTimeAndChangeTimeUnit({preventDefault: () => null} as FocusEvent, NgxTimepickerUnits.MINUTE);
    ...
    describe('changeTimeByKeyboard', () => {
        ...
        beforeEach(() => {
            counter = 0;
            component.timeList = NgxTimepickerUtils.getHours(24);
        });
    ...
    describe('onModelChange', () => {
        ...
        it('should parse value and set it to time property', () => {
            ...
            component.time = '5';
            component.timeUnit = NgxTimepickerUnits.MINUTE;
